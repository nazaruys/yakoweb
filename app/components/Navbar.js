...
function Navbar({ currentPage }) {
  ...
  const navigationItems = [
	...
	return (
		<header
			className={`font-manrope sticky top-7 z-50 shadow-[0_0_30px_rgba(26,6,61,0.20)] hover:shadow-[0_0_30px_rgba(26,6,61,0.25)] flex flex-row items-center justify-between h-[70px] rounded-[40px] mx-48 px-14 bg-secondaryBackground text-black transition-shadow duration-300 ease-in-out`}
		>
			{/* Logo */}
			<a
				href={currentPage ? '/' : '#'}
