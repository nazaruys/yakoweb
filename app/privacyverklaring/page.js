      ...
      <div className="space-y-8">
        <section id="inleiding">
          <p className="text-dark"
             dangerouslySetInnerHTML={{ __html: "Deze Privacyverklaring legt uit hoe wij uw persoonsgegevens verzamelen, gebruiken en beschermen. Deze website en onze diensten worden beheerd door YakoWeb. Als u vragen of verzoeken heeft betreffende uw persoonsgegevens, kunt u contact met ons opnemen via hello@yakoweb.com." }}
          />
        </section>

        <section id="gegevensverzameling">
          <h2 className="text-xl font-semibold mb-4">1. Welke gegevens wij verzamelen</h2>
          <p className="text-dark">Wij verzamelen alleen de minimaal noodzakelijke persoonsgegevens:</p>
        ...
        <section id="verzamelingsmethoden">
          ...
          <p className="text-dark">Wij verzamelen persoonsgegevens wanneer u:</p>
          <ul className="list-disc pl-6 mt-2 space-y-2 text-dark">
        ...
        <section id="doel-gegevensgebruik">
          ...
          <p className="text-dark">Wij verwerken uw gegevens om:</p>
          <ul className="list-disc pl-6 mt-2 space-y-2 text-dark">
          ...
          <p className="text-dark mt-4">De rechtsgrondslag voor het verwerken van uw gegevens is uw toestemming en onze contractuele verplichtingen wanneer u onze diensten gebruikt.</p>
        </section>

        <section id="gegevensbescherming">
          <h2 className="text-xl font-semibold mb-4">4. Hoe wij uw gegevens opslaan en beschermen</h2>
          <p className="text-dark">Wij nemen redelijke maatregelen om uw gegevens veilig te houden. Uw gegevens worden alleen opgeslagen zolang nodig is om onze diensten te verlenen en te voldoen aan wettelijke vereisten. Alle betaalgegevens worden veilig verwerkt via Stripe en worden nooit opgeslagen op onze eigen servers.</p>
        </section>

        <section id="diensten-van-derden">
          <h2 className="text-xl font-semibold mb-4">5. Diensten van derden</h2>
          <p className="text-dark">Wij gebruiken Stripe om betalingen te verwerken. Uw betaalgegevens worden direct door Stripe verwerkt en vallen onder Stripe's eigen privacy- en beveiligingsbeleid. Wij slaan uw volledige betaalinformatie niet op en hebben hier geen toegang toe.</p>
          <p className="text-dark mt-4">Wij delen uw persoonsgegevens niet met andere derden, tenzij wij wettelijk verplicht zijn dit te doen.</p>
        </section>

        <section id="cookies-tracking">
          <h2 className="text-xl font-semibold mb-4">6. Cookies en tracking</h2>
          <p className="text-dark">Wij gebruiken cookies om uw ervaring te verbeteren en te begrijpen hoe bezoekers onze website gebruiken. U kunt via ons cookievoorkeurscentrum bepalen welke cookies u accepteert.</p>
          <div className="mt-4">
            <h3 className="font-semibold mb-2">Soorten cookies die we gebruiken:</h3>
            <ul className="list-disc pl-6 space-y-2 text-dark">
              <li>
                <span className="font-medium">Strikt Noodzakelijke Cookies: </span>
                Deze cookies zijn essentieel voor het goed functioneren van de website en kunnen niet worden uitgeschakeld.
              </li>
              <li>
                <span className="font-medium">Analytics Cookies: </span>
                We gebruiken DataFast analytics om te begrijpen hoe bezoekers onze website gebruiken. Dit helpt ons de prestaties en gebruiksvriendelijkheid van onze website te verbeteren. Deze cookies verzamelen anonieme, geaggregeerde gegevens en omvatten:
          ...
          <div className="text-dark mt-4">
            <ManageCookies>Hier klikken om uw cookievoorkeuren te beheren</ManageCookies>
          </div>
        </section>

        <section id="avg-rechten">
          <h2 className="text-xl font-semibold mb-4">7. Uw rechten onder de AVG</h2>
          <p className="text-dark">Als inwoner van de EU of EER heeft u het recht om:</p>
          <ul className="list-disc pl-6 mt-2 space-y-2 text-dark">
          ...
          <p className="text-dark mt-4"
             dangerouslySetInnerHTML={{ __html: "Om een van deze rechten uit te oefenen, neem contact met ons op via hello@yakoweb.com." }}
          />
        </section>

        <section id="beleidswijzigingen">
          <h2 className="text-xl font-semibold mb-4">8. Wijzigingen in deze Privacyverklaring</h2>
          <p className="text-dark">Wij kunnen dit beleid van tijd tot tijd bijwerken. Wijzigingen zullen worden gepubliceerd op deze pagina, met de bijgewerkte datum hieronder.</p>
        </section>

        <div className="mt-12 pt-8 border-t border-dark/30">
          <p className="text-sm text-dark">Laatst bijgewerkt: 07/11/2025</p>
        </div>
      </div>
    </div>
  );
